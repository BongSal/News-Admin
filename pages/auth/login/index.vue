            ...
            <form @submit.prevent="onSubmit" ref="loginForm">
              ...
              <label class="block text-sm">
                ...
                <input
                  ...
                  required
                  class="block w-full mt-1 border rounded p-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray"
                  placeholder="Janedoe"
                />
              </label>
              <label class="block mt-4 text-sm">
                ...
                <input
                  class="block w-full border rounded p-2 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray"
